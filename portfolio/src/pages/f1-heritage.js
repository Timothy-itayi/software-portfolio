...
<div className="flex  m-20 animate-fade-up  ">
      ...
      An updated version of Grandprix history. 
      </ContentComponent>
   </div>
            ...
            <div className="flex justify-center m-10 mb-6 animate-fade-up  ">
                <LayoutComponent style={{ fontSize: '24px', color: 'white', fontFamily: 'Inter-Regular', paddingLeft: 32 }}>
                    This personal project was made to test my abilities to consume external web APIs and utilise my  frontend skills even more so than before.
                </LayoutComponent>
            </div>
