...
<div className="flex  m-20 animate-fade-up  ">
      ...
      A web application to clone aspects of the Kogan.com  Website - Nav and Product Detail pages.
      </ContentComponent>
   </div>
    ...
    <div className="  bg-black pt-4 ">
        ...
        <li >
            <Link href="https://kogan-test.vercel.app">
                <button className="py-2 px-2 rounded  bg-black hover:bg-red-500 transition duration-300 ease-in-out">
                    <img src='logos/kogan-logo.png' className="h-20 " alt="youtube Logo" />
           
                </button>
            </Link>
            </li>
            <li>
            <Link href="https://github.com/Timothy-itayi/Kogan-test">
