...
const Navbar = () => {
  return (
    <nav className="bg-black">
        <div className="max-w-screen-xl mx-auto px-4 py-3 flex animate-fade-up justify-start">
          <ul className="inline-flex">
            ...
            <li>
              <Link href="https://www.linkedin.com/in/timothy-itayi-ab8754138/">
                ...
                <button className="block py-5 px-6  text-white bg-black hover:bg-gray-300 transition duration-300 ease-in-out ">
